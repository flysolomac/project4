...
function updatePositions() {
    ...
    for (var e = document.body.scrollTop, a = document.querySelectorAll(".mover"), r = 0; r < a.length; r++) {
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noise", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    selectRandomMeat = function() {
        ...
        function n(e) {
            for (var a = r(document.querySelectorAll(".randomPizzaContainer"), e), n = 0; 100 > n; n++) {
                var i = document.querySelectorAll(".randomPizzaContainer")[n].offsetWidth + a + "px";
                document.querySelectorAll(".randomPizzaContainer")[n].style.width = i
            }
        }
